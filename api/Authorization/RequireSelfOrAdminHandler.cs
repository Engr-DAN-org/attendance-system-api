...
public class RequireSelfOrAdminHandler : AuthorizationHandler<RequireSelfOrAdminRequirement>
{
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, RequireSelfOrAdminRequirement requirement)
    {
        // Get the user's role
